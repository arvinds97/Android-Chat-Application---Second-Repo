...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void registerAccount(final String name, final String email, final String mobile, String password, String confirmPassword) {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            Toasty.error(myContext, "Your password doesn't match with your confirm password", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()){
                                ...
                                storeDefaultDatabaseReference.child("user_status").setValue("Hi, I'm new chaton user");
    ...
    private void registerSuccessPopUp() {
        ...
        View view = LayoutInflater.from(RegisterActivity.this).inflate(R.layout.registerpopup, null);
